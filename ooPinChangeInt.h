...
class PinChangeCallBackInterface
{
   public:
...
public:
	...
	static		int8_t attachInterrupt(uint8_t pin, PinChangeCallBackInterface* cbIface, int mode);
...
protected:
	...
	public:
		PCintPin() :
		mode(0) {}
		PinChangeCallBackInterface* 	pinCallBack;
		uint8_t 	mode;
		uint8_t		mask;
		PCintPin* next;
	};
	void		enable(PCintPin* pin, PinChangeCallBackInterface* cbIface, uint8_t mode);
	int8_t		addPin(uint8_t arduinoPin,PinChangeCallBackInterface* cbIface, uint8_t mode);
...
void PCintPort::enable(PCintPin* p, PinChangeCallBackInterface* cbIface, uint8_t mode) {
...
int8_t PCintPort::addPin(uint8_t arduinoPin, PinChangeCallBackInterface* cbIface, uint8_t mode)
{
	PCintPin* tmp;
 ...
 */
int8_t PCintPort::attachInterrupt(uint8_t arduinoPin, PinChangeCallBackInterface* cbIface, int mode)
{
	PCintPort *port;
